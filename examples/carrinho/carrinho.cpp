...
void Carrinho::initializeGL(GLuint program) {
  terminateGL();
...
void Carrinho::paintGL(const GameData &gameData) {
...
void Carrinho::terminateGL() {
  glDeleteBuffers(1, &m_vbo);
  glDeleteBuffers(1, &m_ebo);
  glDeleteVertexArrays(1, &m_vao);
}

void Carrinho::update(const GameData &gameData, float deltaTime) {
  // Rotate
